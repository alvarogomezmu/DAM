...
public class Metodos {
    ...
    public static void leerUsuarios() throws InterruptedException, IOException {
        ...
        ProcessBuilder pb = new ProcessBuilder("CMD", "/C", "dir /b C:\\Users\\Álvaro\\Documents\\Usuarios");

        pb.redirectOutput(new File("C:\\Users\\Álvaro\\Documents\\Usuarios\\usuarios.txt")); // Ubicacion de destino del resultado del comando
    ...
    public static void leerContenidoUsuarios(String user, ProcessBuilder p) throws IOException, InterruptedException {
        ...
        p = new ProcessBuilder("CMD", "/C", "dir /b C:\\Users\\Álvaro\\Documents\\Usuarios\\" + user);

        p.redirectOutput(new File("C:\\Users\\Álvaro\\Documents\\Usuarios\\\\" + user + ".txt"));
    ...
    public static void mostrarContenido() throws FileNotFoundException, IOException {
        ...
        while ((user = leer.readLine()) != null) {
            if (!(user.indexOf('.') >= 0)) {
                BufferedReader carpetaUsuario = new BufferedReader(new FileReader("C:\\Users\\Álvaro\\Documents\\Usuarios\\" + user + ".txt"));
                String linea = null;
