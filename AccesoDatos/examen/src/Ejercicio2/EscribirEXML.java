/*
 * Ejercicio2.
 * Implementar éste árbol XML en java. Lo guardaremos en un fichero llamado ficheroEXML.xml. Debéis crear un procedimiento para escribir el XML escribirEXML y otro para leer dicho fichero leerEXML.
 * Una vez os funcione correctamente crear un tercer procedimiento OperacionesXML que realice las operaciones que más abajo se os indican.
 * Cuando tengáis las operaciones recordad que las tenéis que mostrar para comprobar el/los pasos realizados.
 */
package Ejercicio2;
