...
public class empleado {
    ...
    public static void main(String args[]) {
        ...
        Document doc = null;
        try {
            doc = new SAXBuilder().build("C:\\petra\\empleados.xml");
        ...
        XPathExpression<Element> xpath = XPathFactory.instance().compile("/Empresa/departamento[last()-1]/empleado[last()]/rut", Filters.element());
