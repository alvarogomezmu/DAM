package Ejercicio1;
/*
Crear dos colecciones distintas para poder guardar equipos informáticos (objetos formados por los atributos nombre, cantidad, precio). En una de las colecciones guardaremos los equipos informáticos cuyo precio no tenga descuento y en la otra los mismo equipos pero con descuento.
