...
public class EscribirEXML {
    ...
    public static void main(String args[]) {
        ...
        asignaturas1.addContent(new Element("asignatura").setAttribute("codigo", "a03").setText("Fisica"));
        asignaturas1.addContent(new Element("asignatura").setAttribute("codigo", "a05").setText("Lengua"));
        ...
        // LLamada a la clase Metodos para crear el arbol de 3 niveles
