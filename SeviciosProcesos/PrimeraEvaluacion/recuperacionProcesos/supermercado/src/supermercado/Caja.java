...
public class Caja {
    ...
    public void pagar(int num, int ca, int pa) throws InterruptedException {
        ...
        Ventana.texto_ventana.get(ca).setText(Ventana.texto_ventana.get(ca).getText() + "Cliente numero " + num + " pagando en caja " + ca + "\n");
        sleep(Metodos.generarDormir(5000));
        Ventana.texto_ventana.get(ca).setText(Ventana.texto_ventana.get(ca).getText() + "Cliente numero " + num + " termina en caja " + ca + ", pago " + pa + "\n");
