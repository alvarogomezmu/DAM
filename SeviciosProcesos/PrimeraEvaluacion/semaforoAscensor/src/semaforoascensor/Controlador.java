...
public class Controlador {
    ...
    public static Persona per[] = new Persona[5];
    ...
    public static void nuevaPersona() {
        int pInicio = metodos.plantaAleatoria(); // Planta donde cogera el ascensor
        int pFin = metodos.plantaAleatoria(); // Planta donde se bajara

        // Si las plantas son las mismas, se cambia la de fin
        while (pInicio == pFin) {
            pFin = metodos.plantaAleatoria();
        }
        ...
        Persona p = new Persona(pInicio, pFin, countPersonas,320);
